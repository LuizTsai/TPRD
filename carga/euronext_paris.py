...
if re.match(r'"Date","Product group",,"Generic contract type","Contract code","Contract name","Contract type","Expiry month","Exercise price","Lot size","Exercise type","Settlement price","First price","Highest price","Lowest price","Last price","Volume \(Total\)","Cleared volume \(Block\)","Number of trades \(Total\)","Value of volume in euro \(Total\)","Premium turnover in euro \(Total\)","Open Interest"', line):
	if debug: print "Arquivo tipo 1"	
	tipo_arq = 1
else:
	if debug: print "Arquivo não é tipo 1, testando tipo 2"	
	
	if re.match(r'"Date","Product group",,"Generic contract type","Contract code","Contract name","Contract type","Expiry month","Exercise price","Lot size","Exercise type","Settlement price","First price","Highest price","Lowest price","Last price","Volume \(Total\)","Volume \(Atomx\)","Cleared volume \(Block\)","Number of trades \(Total\)","Value of volume in euro \(Total\)","Premium turnover in euro \(Total\)","Open Interest"', line):
		if debug: print "Arquivo tipo 2"	
		tipo_arq = 2
	else:
